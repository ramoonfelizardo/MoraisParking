...
public class CadastrarOcorrencia extends JFrame {
	...
	public CadastrarOcorrencia() {
		...
		btnAdicionar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				// ----- tira tudo o que ṇo for letra ou n̼mero
	...
	// ----- percorre a lista do Jlist e retorna os veiculos digitados fazendo a verifica̤̣o se esse veiculo consta no sistema
